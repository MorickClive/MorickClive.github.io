    ...
    return <div className='blogCards' >
        ...
        <div id="first_post" className='card'>
            <div className="body">
                ...
                <p>
                    My name is Alan Davies and this is my first blog post.<br />
                    Hopefully, this will be a way to keep track of developments and action plans.<br />
        ...
        <div id="web_dev" className='card'>
            <div className="body">
                ...
                <p>
                    I hope this site can aid in recording the development of new skills and interests in the future and provide access to some of my older projects.<br />
                ...
                <div className="imageBlock">
                    ...
                    <p>
                        Designed around an art piece focusing on my Guild Wars 2 character: 'Aster', it explores silhouette themes with a limited colour palette.<br />
                        <br />
