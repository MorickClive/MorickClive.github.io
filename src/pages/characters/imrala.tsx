...
export default function ImralaPage() {
  const common_path = "/data/characters/imrala/";
  const file_path = `${common_path}/imrala.json.enc`;
  const image_key = `${common_path}/img/imrala.key`;
