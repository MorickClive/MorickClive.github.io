...
export default function about() {
    return <>
        ...
        <div className="container" >
            ...
            <div className="div footer" />
            <p>
                Primarily a Java developer with a testing focus, I follow TDD and BDD practices to maintain digital applications.
                I strive for good code coverage, having experience in automated testing with JUnit, Selenium and static code analysis with Sonarqube.
            </p>
            <div className="div footer" />
        </div>
