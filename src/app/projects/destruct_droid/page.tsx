...
export default function project() {
    ...
    return <>
        <div className="container">
            ...
            <p><em>Project members: Alan Davies, Jake Reynolds, James Evans, Kiran Pabari, Harry Conibere, Sean Skinner</em></p>
            <hr />
            <h4>About:</h4>
            ...
            <h4>Final Scenes</h4>
            <hr />
            <p><em><strong>Project created by</strong>: &nbsp;team, 2015.</em></p>
            <p><em><strong>Module Lecturer</strong>: Mike Reddy&nbsp;(University of South Wales)</em></p>
            <hr />
            <p><em><strong>Project team</strong></em></p>
            <hr />
            ...
            <hr />
            <Link href={`../projects#destruct_droid`}>[ return ]</Link>
        </div>
