...
export default function projects() {
    ...
    return <>
        <div className="container">
            ...
            <p>I've worked on many different projects, I've provided a few projects below for viewing. Currently I'm looking to extend these project pages by adding image galleries and links to respective resources!</p>
        </div>
        <ProjectSections />
    </>
}
