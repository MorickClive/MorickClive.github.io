...
export default function project() {
    ...
    return <>
        <div className="container">
            ...
            <p><a href="https:www.cnclabs.com/forums/default.aspx?g=posts&amp;t=9040">CnCLabs Forum post&nbsp;“<b>Battlebase Koi</b>“</a></p>
            <p><a href="https:www.cnclabs.com/forums/default.aspx?g=posts&amp;t=9015">CnCLabs Forum post “<strong>A Place in the Heavens</strong>“</a></p>
            <hr />
            <p><em>Created with:&nbsp;Command &amp; Conquer™: Red Alert™ &nbsp;3 World Builder,&nbsp;</em><em>(Tool set provided by EA)</em></p>
            ...
            <hr />
            <Link href={`../projects#community_map_development`}>[ return ]</Link>
        </div>
        <div className="container">
            <h2>Image Gallery</h2>
