...
export default function project() {
    return <>
        <div className="container">
            ...
            <a href={imageList[0]} target="_blank"><img src={imageList[0]} width="424" height="241" /></a>
            <hr />
            ...
            <p ><em>Ccreated by Alan Davies, 2016.</em></p>
        ...
        <div className="container">
            ...
            <CreateCarousel height="500px" imgList={imageList} />
        </div>
    </>
}
